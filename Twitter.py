...
request = api.request('statuses/filter', {'track': "I'm listening to on #pandora "}) 


def main():
    
    tweet = None
    with io.open("twitter3.json", mode='a+', encoding='utf-8') as outfile:
        ...
        for r in request:
            ...
            outfile.write(json.dumps(tweet, ensure_ascii=False, encoding='utf-8') + u"\n")
